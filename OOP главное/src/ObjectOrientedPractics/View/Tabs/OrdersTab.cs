...
namespace ObjectOrientedPractics.View.Tabs
{
    public partial class OrdersTab : UserControl
    {
        ...
        public OrdersTab()
        {
            ...
            DeliveryTimeComboBox.DataSource = PriorityOrder.Times;
            PriorityPanel.Visible = false;
        }
        ...
        private void UpdateAllBoxes()
        {
            ...
            else
            {
                ...
                CreatedTextBox.Text = Orders[SelectedIndex].Date.ToString();
        ...
        private void DeliveryTimeComboBox_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            var priorityOrder = (PriorityOrder)Orders[SelectedIndex];
            priorityOrder.Time = DeliveryTimeComboBox.SelectedItem.ToString();
        }
    }
}
